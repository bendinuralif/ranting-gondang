...
function TambahKetuaRanting() {
  ...
  const MAIN_COLLECTION = "your_main_collection_name_here";
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setErrorMessage("Error fetching Firestore data: " + error.message);
      }
    };
  ...
  return (
    <LayoutAdmin>
      <div>
        <h2 className="text-lg md:text-2xl font-semibold p-4">Tambah Ketua Ranting</h2>
      </div>
...
export default TambahKetuaRanting;