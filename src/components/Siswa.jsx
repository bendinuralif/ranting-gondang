    ...
    return (
      <Layout>
        ...
        <div className="justify-center items-center px-5">
          <div className="px-2 block mx-auto max-w-7xl mt-10 mb-10 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <div className="relative overflow-x-auto mt-4">
              <table className="w-full text-xs md:text-sm text-left rtl:text-right text-gray-700 dark:text-gray-600">
                ...
                <tbody>
                  {data.sort((a, b) => a.no - b.no).map((item, index) => (
